...
public class CheckMethods implements IMobileUtils {
    ...
    public boolean isWrongDesign() {
        boolean isNotGoodDesign = goodDesignLocator.isElementNotPresent(5);
//        boolean isNotGoodDesign =  driver.findElements(By.xpath(GOOD_DESIGN_LOCATOR)).size() < 1;
        return isNotGoodDesign;
    }
}